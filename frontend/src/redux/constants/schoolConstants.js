...
export const SCHOOL_PROGRAMME_REQUEST = "SCHOOL_PROGRAMME_REQUEST";
export const SCHOOL_PROGRAMME_SUCCESS = "SCHOOL_PROGRAMME_SUCCESS";
export const SCHOOL_PROGRAMME_FAIL = "SCHOOL_PROGRAMME_FAIL";
