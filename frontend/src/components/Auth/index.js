  ...
  return (
    <div className={classes.root}>      
        ...
        >
          <Tab 
            label="Sign Up" 
            icon={<i className="fas fa-user-plus"></i>} {...a11yProps(0)} 
            style={{backgroundColor: signInActive && colors.white,
          ...
          <Tab 
            label="Sign In" 
            icon={<i className="fas fa-sign-in-alt"></i>} {...a11yProps(1)}    
            style={{backgroundColor: signUpActive && colors.white,
